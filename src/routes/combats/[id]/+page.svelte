...
{:else}
    <div class="mx-auto flex min-h-dvh w-full flex-col pb-56 lg:pb-8">
        ...
        {:else}
            ...
            <Button
                    size="fab"
                    class="fixed right-4 bottom-[max(1rem,env(safe-area-inset-bottom))] shadow-lg lg:hidden max-lg:focus-visible:ring-0 max-lg:focus-visible:border-transparent"
            ...
            {#if combat.combatants.length > 0}
                ...
                <FAB
                        ...
                        class="bottom-[calc(max(1rem,env(safe-area-inset-bottom))_+_5rem)] lg:hidden max-lg:focus-visible:ring-0 max-lg:focus-visible:border-transparent"
                />
            {/if}
        {/if}
    </div>
