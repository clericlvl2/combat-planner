...
{:else}
    <div class="mx-auto flex min-h-dvh w-full flex-col pb-56 lg:pb-8">
        ...
        {:else}
            ...
            <Button
                    size="fab"
                    class="fixed right-4 bottom-[calc(1rem_+_env(safe-area-inset-bottom))] shadow-lg lg:hidden max-lg:focus-visible:ring-0 max-lg:focus-visible:border-transparent"
            ...
            {#if combat.combatants.length > 0}
                ...
                <FAB
                        ...
                        class="bottom-[calc(6rem_+_env(safe-area-inset-bottom))] lg:hidden max-lg:focus-visible:ring-0 max-lg:focus-visible:border-transparent"
                />
            {/if}
        {/if}
    </div>
