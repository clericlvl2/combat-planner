...
describe('HP transitions (Rules §4, Data §9)', () => {
...
describe('editCombatant — Max HP is a discrete undo step (Data §7/§8)', () => {
...
describe('roster (Data §6/§7, Rules §8)', () => {
...
describe('clearCombat / restart (Data §7)', () => {
