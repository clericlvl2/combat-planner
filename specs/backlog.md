...
|----|-----|------|-------|---------|---------|------|
| W-030 | S | small | active | Drawer swipe-close dead spots — form controls (stepper, toggle pills, chips, footer, raw search input) contest the vaul gesture in CombatantForm + LibraryEntryFormDialog | — | — |
