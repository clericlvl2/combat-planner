...
export class CombatStore {
	...
	/** Boot: load + normalize/migrate from Dexie, then run first-launch (Data §7). */
	...
	/** Reset-all: clear combats, keep language/theme, re-arm first-launch (Data §7). */
